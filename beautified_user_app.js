! function(_) {
  function e(e) {
    for (var r, t, l = e[0], i = e[1], s = e[2], d = 0, c = []; d < l.length; d++) t = l[d], Object.prototype.hasOwnProperty.call(o, t) && o[t] && c.push(o[t][0]), o[t] = 0;
  ...
  function a() {
    for (var _, e = 0; e < n.length; e++) {
      for (var a = n[e], r = !0, t = 1; t < a.length; t++) {
        var i = a[t];
        0 !== o[i] && (r = !1)
      }
      r && (n.splice(e--, 1), _ = l(l.s = a[0]))
    }
    return _
  }
  var r = {},
  ...
  l.e = function(_) {
    ...
    t[_] ? e.push(t[_]) : 0 !== t[_] && {
      ...
      for (var r = "static/user/css/" + ({
          manifest: "manifest"
        } [_] || _) + "." + {
          manifest: "d9ff5769"
        } [_] + ".css", o = l.p + r, n = document.getElementsByTagName("link"), i = 0; i < n.length; i++) {
        var s = (u = n[i]).getAttribute("data-href") || u.getAttribute("href");
        if ("stylesheet" === u.rel && (s === r || s === o)) return e()
      }
      var d = document.getElementsByTagName("style");
      for (i = 0; i < d.length; i++) {
        var u;
        if ((s = (u = d[i]).getAttribute("data-href")) === r || s === o) return e()
      }
      var c = document.createElement("link");
      c.rel = "stylesheet", c.type = "text/css", c.onload = e, c.onerror = function(e) {
        var r = e && e.target && e.target.src || o,
          n = new Error("Loading CSS chunk " + _ + " failed.\n(" + r + ")");
        n.code = "CSS_CHUNK_LOAD_FAILED", n.request = r, delete t[_], c.parentNode.removeChild(c), a(n)
      ...
      var toggleLayout = function() {
        ...
        if (a.length > 0 && a.forEach((function(_) {
          ...
          if (jquery__WEBPACK_IMPORTED_MODULE_5___default()("body").hasClass("sidebar-mini") && (toggle_sidebar_mini(!1), jquery__WEBPACK_IMPORTED_MODULE_5___default()(".main-sidebar").niceScroll(sidebar_nicescroll_opts), sidebar_nicescroll = jquery__WEBPACK_IMPORTED_MODULE_5___default()(".main-sidebar").getNiceScroll()), jquery__WEBPACK_IMPORTED_MODULE_5___default()("body").addClass("sidebar-gone"), jquery__WEBPACK_IMPORTED_MODULE_5___default()("body").removeClass("layout-2 layout-3 sidebar-mini sidebar-show"), jquery__WEBPACK_IMPORTED_MODULE_5___default()("body").off("click touchend").on("click touchend", (function(_) {
            ...
            var o = jquery__WEBPACK_IMPORTED_MODULE_5___default()(".main-sidebar");
            o.find(".container").addClass("sidebar-wrapper").removeClass("container"), o.find(".navbar-nav").addClass("sidebar-menu").removeClass("navbar-nav"), o.find(".sidebar-menu .nav-item.dropdown.show a").click(), o.find(".sidebar-brand").remove(), o.find(".sidebar-menu").before(jquery__WEBPACK_IMPORTED_MODULE_5___default()("<div>", {
              class: "sidebar-brand"
              ...
              sidebar_nicescroll = o.niceScroll(sidebar_nicescroll_opts), sidebar_nicescroll = o.getNiceScroll()
          ...
          var n = jquery__WEBPACK_IMPORTED_MODULE_5___default()(".main-sidebar").attr("data-nav-classes"),
            l = jquery__WEBPACK_IMPORTED_MODULE_5___default()(".main-sidebar");
          if ("layout-3" == now_layout_class && l.hasClass("main-sidebar")) {
            l.find(".sidebar-menu li a.has-dropdown").off("click"), l.find(".sidebar-brand").remove(), l.removeAttr("class"), l.addClass(n);
  ...
  "56d7": function(_, e, a) {
    ...
    var r = a("7a23"),
      ...
      o = (a("da96"), a("d3b7"), a("6c02")),
      n = [{
        path: "",
        component: function() {
          return Promise.all([a.e("vendor"), a.e("manifest")]).then(a.bind(null, "7557"))
        },
        children: [{
          path: "",
          name: "home",
          component: function() {
            return Promise.all([a.e("vendor"), a.e("manifest")]).then(a.bind(null, "c2e5"))
          }
        }, {
          path: ":id/detail",
          name: "detail",
          component: function() {
            return Promise.all([a.e("vendor"), a.e("manifest")]).then(a.bind(null, "637f"))
          }
        }, {
          path: ":id/pay",
          name: "pay",
          component: function() {
            return Promise.all([a.e("vendor"), a.e("manifest")]).then(a.bind(null, "4b5d"))
          }
        }, {
          path: "search",
          component: function() {
            return Promise.all([a.e("vendor"), a.e("manifest")]).then(a.bind(null, "16ee"))
          }
        }, {
          path: "qrcode",
          name: "qrcode",
          component: function() {
            return Promise.all([a.e("vendor"), a.e("manifest")]).then(a.bind(null, "c626"))
          }
        }, {
          path: "contact",
          component: function() {
            return a.e("manifest").then(a.bind(null, "487d"))
          }
        }]
      }],
      l = new o.a({
    ...
    var i = {
        render: function(_, e) {
          ...
          return Object(r.u)(), Object(r.f)(r.b, {
            name: "fade"
          }, {
